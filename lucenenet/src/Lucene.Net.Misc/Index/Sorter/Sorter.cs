...
namespace Lucene.Net.Index.Sorter
{
    ...
    public sealed class Sorter
    {
        ...
        public static AtomicReader GetSortedMergeReader(IList<AtomicReader> unsortedReaders, Sorter sorter, out Sorter.DocMap docMap)
        {
            ...
            return SortingAtomicReader.Wrap(atomicView, docMap);
        }
