...
namespace Lucene.Net.Index
{
    ...
    public sealed class MultiTermsEnum : TermsEnum
    {
        ...
        public int MatchCount { get => numTop; set => numTop = value; }
        ...
        public IReadOnlyList<TermsEnumWithSlice> ActiveSubReaderSlices => currentSubs;

        public Util.PriorityQueue<TermsEnumWithSlice> TermQueue => queue;
        ...
        public void SetTerm(BytesRef term, int matchCount)
        {
            current = term;
            numTop = matchCount;
        }

        public void SetTerm(BytesRef term)
        {
            current = term;
        }
        ...
        private void PullTop(bool allowPrefixCheck = true)
        {
        ...
        private void PushTop()
        {
            ...
            {
                var topi = top[i];
                topi.Current = topi.Next();
                if (topi.Current != null)
                {
        ...
        {
            internal ReaderSlice SubSlice { get; }
            internal TermsEnum Terms { get; set; }
            public BytesRef Current { get; set; }
            public int SubSliceStart { get; }

            public int PrefixLength = int.MaxValue;
            internal int Index { get; private set; }

            internal int TermOrdinal { get; private set; } = -1;
            ...
            public TermsEnumWithSlice(int index, ReaderSlice subSlice)
            {
                ...
                this.SubSliceStart = SubSlice.Start;
            }
