...
namespace Lucene.Net.Index
{
    ...
    public sealed class SegmentInfo
    {
        ...
        public SegmentInfo(Directory dir, string version, string name, int docCount, bool isCompoundFile, Codec codec, IDictionary<string, string> diagnostics, IDictionary<string, string> attributes)
        {
            ...
            this.Name = name;
            this.Ordinal = GetSegmentOrdinal(name);
...
#pragma warning restore 612, 618
        ...
        public static int GetSegmentOrdinal(string segmentName)
        {
            return ConvertBase36ToInt(segmentName.AsSpan().TrimStart('_'));
        }

        private static int ConvertBase36ToInt(ReadOnlySpan<char> base36String)
        {
            int result = 0;
            ...
            int getCharValue(char c)
            {
                ...
                throw new FormatException($"'{c}' is not valid base 36 character.");
            }
