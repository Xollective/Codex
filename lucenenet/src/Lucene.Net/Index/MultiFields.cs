...
namespace Lucene.Net.Index
{
    ...
    public sealed class MultiFields : Fields
    {
        ...
        /// yourself.
        /// </summary>
        public static Fields GetFields(IndexReader reader, bool forceSliceAware = false)
        {
            ...
            switch (leaves.Count)
            {
                ...
                case 1:
                    if (forceSliceAware && leaves[0].DocBase != 0) goto default;
                ...
                default:
                    ...
                    else if (fields.Count == 1 && (!forceSliceAware || slices[0].Start == 0))
                    {
                        return fields[0];
                    }
                    else
