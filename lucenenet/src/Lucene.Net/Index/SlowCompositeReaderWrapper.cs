...
namespace Lucene.Net.Index
{
    ...
    public sealed class SlowCompositeReaderWrapper : AtomicReader
    {
        ...
        /// </summary>
        public static AtomicReader Wrap(IndexReader reader, bool forceSliceAware = false)
        {
            if (reader is CompositeReader compositeReader)
            {
                return new SlowCompositeReaderWrapper(compositeReader, forceSliceAware);
            }
            else
            {
        ...
        private SlowCompositeReaderWrapper(CompositeReader reader, bool forceSliceAware)
            : base()
        {
            @in = reader;
            fields = MultiFields.GetFields(@in, forceSliceAware);
