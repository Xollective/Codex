...
{
    using static Lucene.Net.Search.FilteredQuery;
    /*
...
*/
    ...
    {
        public virtual FilterStrategy FilterStrategy => null;
        ...
        /// </param>
        /// <returns></returns>
        public static Filter NewAnonymous(Func<AtomicReaderContext, IBits, DocIdSet> getDocIdSet, FilterStrategy strategy = null)
        {
        ...
        private class AnonymousFilter : Filter
        {
            ...
            public override FilterStrategy FilterStrategy { get; }

            public AnonymousFilter(Func<AtomicReaderContext, IBits, DocIdSet> getDocIdSet, FilterStrategy strategy = null)
            {
