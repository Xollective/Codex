...
namespace Lucene.Net.Util // from org.apache.solr.util rev 555343
{
    ...
    public static class BitUtil // LUCENENET specific - made static
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static long Pop_Array(ReadOnlySpan<long> arr, int wordOffset, int numWords)
        {
            long popCount = 0;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static long Pop_Intersect(ReadOnlySpan<long> arr1, ReadOnlySpan<long> arr2, int wordOffset, int numWords)
        {
            long popCount = 0;
            for (int i = wordOffset, end = wordOffset + numWords; i < end; ++i)
            {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static long Pop_Union(ReadOnlySpan<long> arr1, ReadOnlySpan<long> arr2, int wordOffset, int numWords)
        {
            long popCount = 0;
            for (int i = wordOffset, end = wordOffset + numWords; i < end; ++i)
            {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static long Pop_AndNot(ReadOnlySpan<long> arr1, ReadOnlySpan<long> arr2, int wordOffset, int numWords)
        {
            long popCount = 0;
            for (int i = wordOffset, end = wordOffset + numWords; i < end; ++i)
            {
