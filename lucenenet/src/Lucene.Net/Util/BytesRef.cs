...
namespace Lucene.Net.Util
{
    ...
    public sealed class BytesRef : IComparable<BytesRef>, IComparable, IEquatable<BytesRef> // LUCENENET specific - implemented IComparable for FieldComparator, IEquatable<BytesRef>
    {
        ...
        public Memory<byte> Memory => Bytes.AsMemory(Offset, Length);
        ...
        public void Sync(BytesRef other)
        {
            bytes = other.bytes;
            Offset = other.Offset;
            Length = other.Length;
        ...
        /// new reference array.
        /// </summary>
        public void CopyBytes(BytesRef other, int length)
        {
            ...
            Arrays.Copy(other.bytes, other.Offset, bytes, Offset, length);
            Length = length;
        }

        public BytesRef Truncate(int truncatedLength)
        {
            Debug.Assert(truncatedLength <= Length);
            return new BytesRef(Bytes, Offset, truncatedLength);
        }
