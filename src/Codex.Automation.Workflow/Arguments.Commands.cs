        ...
        public static Command AddInternalCommand(Arguments arguments, Mode mode)
        {
            ...
            return CliModel.Bind<Arguments>(
                ...
                m =>
                {
                    ...
                    {
                        m.Option(argList(c => ref c.AdditionalCodexArguments, out init), init: init, name: "additional-codex-arguments", required: false,
                    ...
                    m.Option(c => ref c.DisablePrepare, name: "no-prepare", required: false,
                        description: "Upload prepare");

                    m.Option(c => ref c.DisableUpload, name: "no-upload", required: false,
                        description: "Upload upload artifacts when applicable");
