...
namespace BuildXL.Utilities.Collections
{
    ...
    public sealed class BigBuffer<TEntry> : IArray<TEntry>
    {
        private static int s_entrySize = TryComputeEntrySize();

        public int Length => m_capacity;
