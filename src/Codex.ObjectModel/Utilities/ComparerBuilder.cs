...
{
    public interface IUnifiedComparer<in T> : IEqualityComparer<T>, IComparer<T>
    {
    }
    ...
    public class ComparerBuilder<T> : Comparer<T>, IUnifiedComparer<T>
    {
        ...
        public ComparerBuilder<T> CompareByAfter<TCompare>(Func<T, TCompare> keySelector, IComparer<TCompare> comparer = null, IEqualityComparer<TCompare> equalityComparer = null)
        {
            comparer = comparer ?? Comparer<TCompare>.Default;
            comparers.AddLast(new SelectorComparer<TCompare>(keySelector, comparer));
            _equalityComparer.CompareByAfter(keySelector, equalityComparer);
            return this;
        }
        ...
        public ComparerBuilder<T> CompareByBefore<TCompare>(Func<T, TCompare> keySelector, IComparer<TCompare> comparer = null, IEqualityComparer<TCompare> equalityComparer = null)
        {
            comparer = comparer ?? Comparer<TCompare>.Default;
            comparers.AddFirst(new SelectorComparer<TCompare>(keySelector, comparer));
            _equalityComparer.CompareByBefore(keySelector, equalityComparer);
            return this;
        }
