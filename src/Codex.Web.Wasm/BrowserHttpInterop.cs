...
namespace System.Net.Http
{
    internal static partial class BrowserHttpInterop
    {
        ...
        public static async ValueTask<T> CancellationHelper<T>(Task<T> promise, CancellationToken cancellationToken, JSObject? abortController = null, JSObject? fetchResponse = null)
        {
        ...
        public static T CancellationHelperSync<T>(Task<T> promise, CancellationToken cancellationToken, JSObject? abortController = null, JSObject? fetchResponse = null)
        {
            if (promise.IsCompletedSuccessfully)
            {
                return promise.Result;
    ...
    {
        internal static Exception CreateOperationCanceledException(Exception oce, CancellationToken cancellationToken)
        {
