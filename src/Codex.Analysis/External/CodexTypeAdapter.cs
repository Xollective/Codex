...
namespace Codex.Analysis.External
{
    public class CodexTypeAdapter
    {
        ...
        public static ClassificationSpan Annotate(BoundSourceFileBuilder builder, CodexSemanticStore store, CodexSpan span)
        {
        ...
        public static ReferenceSpan ToReference(CodexSemanticStore store, BoundSourceFileBuilder builder, CodexSpan span)
        {
            ...
            return new ReferenceSpan()
            {
                ...
                {
                    Id = symbolId,
                    ReferenceKind = Enum.TryParse<ReferenceKind>(store.ReferenceKinds[span.ReferenceKind].Name, out var refKind) ? refKind : ReferenceKind.Reference,
                    Kind = symbol.Kind,
                    ProjectId = projectId,
                },
            };
