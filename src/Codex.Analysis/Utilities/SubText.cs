...
namespace Microsoft.CodeAnalysis.Text
{
    ...
    {
        public SubSourceText(SourceText text, TextSpan span)
        ...
        {
            return new SubSourceText(UnderlyingText, GetCompositeSpan(span.Start, span.Length));
        }

        public SubSourceText Substring(TextSpan span)
        {
            CheckSubSpan(span);
        ...
        public SubSourceText Substring(int start)
        {
            return Substring(new TextSpan(start, Length - start));
        }

        public SubSourceText Substring(int start, int length)
        {
        ...
        /// <inheritdoc />
        public static bool operator ==(SubSourceText left, string right)
        {
    ...
    public static class SubSourceTextExtensions
    {
        public static SubSourceText TrimEnd(this SubSourceText text)
        {
            return Trim(text, trimStart: false, trimEnd: true);
        }

        public static SubSourceText TrimStart(this SubSourceText text)
        {
            return Trim(text, trimStart: true, trimEnd: false);
        }

        public static SubSourceText Trim(this SubSourceText text, bool trimStart = true, bool trimEnd = true)
        {
            if (text.Length == 0)
            {
                return text;
